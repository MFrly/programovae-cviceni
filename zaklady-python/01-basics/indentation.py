...
print("chces videt kouzlo")
kouzlo="alahu akbar"
def abrakadabra(slovo):
    """"
    funkce vypisuje cisla od jedne do jedenacti
    a namisto nich vypisuje tik tok
    pokud dojde na cislo jedenact vypise se kouzlo
    """""
    n = 0
    print(n)
    for n in range(1, 11):
